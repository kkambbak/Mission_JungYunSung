...
public class NotProd {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            Member memberUser5ByKakao = memberService.whenSocialLogin("KAKAO", "KAKAO__2733187651").getData();
            Member memberUser6ByGoogle = memberService.whenSocialLogin("GOOGLE", "GOOGLE__112989246332996510578").getData();
